            ...
            <section className="statusBox">
                ...
                <ul>
                    {this.props.slots && this.props.slots.map((it, i) => <li key={i}>
                        ...
                        <h5>Status: {'\u00a0'} <a className={this.props.slots.indexOf(this.props.currentSlot) === i ? "Active" : this.props.currentSlot && this.props.slots.indexOf(this.props.currentSlot) < i ? "Next" : "Ended"}>{this.props.slots.indexOf(this.props.currentSlot) === i ? "Active" : this.props.currentSlot && this.props.slots.indexOf(this.props.currentSlot) < i ? "Next" : "Ended"}</a></h5>
                    </li>)}
                </ul>
            </section>
        </section>
