var Switch = React.createClass({
    ...
    max() {
        this.props.balanceOf && this.controller.getBalanceOf().then(balance => this.input.value = window.fromDecimals(balance, 18, true));
        this.onChange();
    },
    approve(e) {
        ...
        return (<section>
            ...
            <h3>Switch</h3>
                <section className="switchTools">
                    ...
                    <a className="switchLink" href={window.getNetworkElement("etherscanURL") + "token/" + window.oldToken.options.address} target="_blank">$BUIDL<b> V1</b></a>
                    <img src="/assets/img/buidl-logo.png"></img>
                </section>
            <h3>For</h3>
                <section className="switchTools">
                    <span ref={ref => (this.switchFinal = ref) && this.onChange()} className="switchFinal">0</span>
                    <a className="switchLink" href={window.getNetworkElement("etherscanURL") + "token/" + this.props.newVotingTokenAddress} target="_blank">$buidl<b> V2</b></a>
